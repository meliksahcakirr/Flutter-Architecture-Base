...
abstract class {{feature_name.pascalCase()}}RemoteDataSourceImpl implements {{feature_name.pascalCase()}}RemoteDataSource {

  @override
  Future<Result<{{domain_model_name.pascalCase()}}Remote>> fetch({required String id}) async {
    try {
